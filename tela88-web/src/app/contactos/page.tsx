          ...
          <div className="relative mx-auto max-w-[1240px] px-6 md:px-12">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-6 max-w-[10ch] font-headline text-5xl font-bold leading-[0.9] tracking-[-0.05em] text-on-surface sm:text-6xl md:text-7xl xl:text-[5.4rem]">
                Diz-nos onde o negócio <span className="text-primary-container">está a travar.</span>
              </h1>

              <p className="mt-8 max-w-[40rem] font-body text-lg leading-[1.75] text-on-surface/66">
            ...
            <div className="mt-14 grid gap-4 md:grid-cols-3">
              {[
                ...
                >
                  <p className="font-body text-sm leading-relaxed text-on-surface/58">{item}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="mx-auto max-w-[1240px] px-6 pb-20 md:px-12 md:pb-24">
          <div className="grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)]">
            <aside className="space-y-5">
              <div className="rounded-[1.7rem] border border-white/8 bg-surface-container-low/72 p-6">
                <p className="font-label text-[10px] uppercase tracking-[0.22em] text-primary-container">
                  O que vais ganhar
                </p>
                <div className="mt-4 space-y-3">
                  {[
                    "Clareza sobre o maior bloqueio do negócio",
                    "Prioridades mais simples para os próximos passos",
              ...
              <p className="px-1 font-body text-sm leading-relaxed text-on-surface/44">
                Resposta habitual em menos de 24 horas úteis.
              </p>
            </aside>

            <div>
              {status === "success" ? (
                <div className="rounded-[2rem] border border-white/8 bg-surface-container-low/72 p-10 text-center md:p-14">
                ...
                <form
                  ...
                  noValidate
                  className="rounded-[2rem] border border-white/8 bg-surface-container-low/72 p-8 shadow-[0_22px_60px_-48px_rgba(0,0,0,0.95)] md:p-10"
                >
